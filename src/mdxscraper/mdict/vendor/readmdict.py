...
class MDict(object):
    ...
    def _decode_key_block_info(self, key_block_info_compressed):
        ...
        while i < len(key_block_info):
            ...
            num_entries += unpack(self._number_format, key_block_info[i : i + self._number_width])[
                0
            ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-p", "--passcode", default=None, type=passcode, help="register_code,email_or_deviceid"
    )
