...
def test_preset_category_creation():
    ...
    category = PresetCategory(name="pdf", label="PDF Presets", description="PDF conversion presets")
...
def test_preset_category_defaults():
    ...
    category = PresetCategory(name="css", label="CSS Presets")
...
def test_preset_category_with_presets():
    ...
    category = PresetCategory(name="pdf", label="PDF Presets", presets=[preset1, preset2])
...
def test_preset_info_creation():
    ...
    preset_info = PresetInfo(
        name="test_preset", label="Test Preset", description="A test preset", category="pdf"
    )
...
def test_preset_info_defaults():
    ...
    preset_info = PresetInfo(name="test_preset", label="Test Preset")
...
def test_preset_data_creation():
    ...
    preset_data = PresetData(info=info, content=content)
...
def test_preset_data_with_metadata():
    ...
    preset_data = PresetData(info=info, content=content, metadata=metadata)
...
def test_preset_data_complex_metadata():
    ...
    metadata = {
        ...
        "author": "test",
        "tags": ["pdf", "conversion"],
        "settings": {"margin": "1in", "orientation": "portrait"},
    }
...
def test_preset_data_none_metadata():
    ...
    preset_data = PresetData(info=info, content=content, metadata=None)
